...
###stuff to write to a csv file. Change the print statements on naming scenes and task runs to OUTPUTFILE.write( <the line without 'print'> + '\n' )
CURRENTDIR = os.getcwd()
DATADIR = CURRENTDIR+ "/data"
OUTPUTFILENAME = DATADIR + "/CHOICE_RUN_"+ curtime + ".csv"
OUTPUTFILE = open( OUTPUTFILENAME, "w")


display_wait_scene()

OUTPUTFILE.write( present_choice_single(target_images, [ seeds[0] ]) )
OUTPUTFILE.write("\n");
