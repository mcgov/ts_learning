...
###stuff to write to a csv file. Change the print statements on naming scenes and task runs to LEARNING_TASK_FILE.write( <the line without 'print'> + '\n' )
CURRENTDIR = os.getcwd()
DATADIR = CURRENTDIR+ "/data"
LEARNING_TASK_FILENAME = DATADIR + "/CHOICE_LEARNING_"+ curtime + ".csv"
...
LEARNING_TASK_FILE.write( present_choice_single(target_images, [ seeds[0] ]) )
...
for block in range(1):	  ########## NOTE: adjust the amount of times this runs a single by adjusting the integer in the parenthesis there <<< --------
	...
	LEARNING_TASK_FILE.write( present_choice_double(target_images, seeds[1], seeds[2] ) )
	LEARNING_TASK_FILE.write("\n");
...
for block in range(1):	########## NOTE: You can adjust the amount of times this runs  by adjusting the integer in the parenthesis there <<< --------
	...
	LEARNING_TASK_FILE.write( present_choice_quadruple(target_images, seeds[3], seeds[4], seeds[5] ,seeds[6] ) )
	LEARNING_TASK_FILE.write("\n");
...
for block in range (1):     ########## NOTE: You can adjust the amount of times this runs by adjusting the integer in the parenthesis there <<< --------
	...
	LEARNING_TASK_FILE.write( present_choice_octuple(target_images, seeds[7], seeds[8], seeds[9] ,seeds[10] ,seeds[11] ,seeds[12], seeds[13], seeds[14] ) )
	LEARNING_TASK_FILE.write("\n");
